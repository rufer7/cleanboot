...
Compile-Schritt, ohne Paketierung, ohne Depencency-Hölle. Man kann dieses
Kapitel als Exploration lesen, wie sich Webentwicklung ohne Frameworks nur 
mit Web-Standards anfühlt. Am Schluss muss man selbst entscheiden, ob das 
...
Eine der zentralen Funktionen ist safeHTML, das uns das \textit{Escapen} 
